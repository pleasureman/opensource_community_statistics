...
echo "Updated time: `date '+%Y/%m/%d %H:%M:%S'`" >> ${REPORT}
echo "" >> ${REPORT}

line1="||||"
line2="| ------------- |:-------------:| -----:|"
line3="| num | author | all |"
for i in $communitylist
do
	line1="${line1}|"
	line2="${line2} -----:|"
...
do
	...
	#echo "<td align=center><b>${allpatchquantity}</b></td>" >> ${REPORT}
	linen="|${num}|${author}|${allpatchquantity}|"
...
cd ~/patch/opensource_community_statistics/data
cp ${REPORT} ~/patch/opensource_community_statistics/data -rf
git add 2016.md
